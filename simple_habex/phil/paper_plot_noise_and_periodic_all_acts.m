...
naa.mean_delta_ni_list = [5.0261e-13 1.9941e-12 4.4592e-12 7.8967e-12 ...
    1.2336e-11 1.7897e-11 2.4245e-11 3.1432e-11]
...
hold all
plot(naa.std_list, naa.mean_delta_ni_list/1e-11,'linewidth',3)
grid on
xlabel('Voltage RMS [mV]')
ylabel('Delta NI (1E-11)')
title('Periodic and Gaussian Noise on All Actuators on Both DMs')
xlim([0 1])
ylim([0 3])
set(gca,'fontsize',16)
xlim([0 0.8])
legend('Periodic','Gaussian')